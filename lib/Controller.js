...
const Controller = {
    ...
    init(pollIntervall, displayAddress, sensorPIN, sensorType, sondeAddress, goodTempMin, goodTempMax, goodHumMin, goodHumMax, mediumDelta, readCallback) {
        ...
        this.webserver = Webserver(80, this.settingsCallback);
    ...
    settingsCallback(data) {
        this.goodTempMax = data.maxTemp;
        this.goodTempMin = data.minTemp;
        this.mediumDelta = data.delta;

        this.goodHumMin = data.minHum;
        this.goodHumMax = data.maxHum;
    },
